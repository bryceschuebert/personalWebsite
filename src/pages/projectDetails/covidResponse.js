          ...
          <div className="inner">
            ...
            <div>
              ...
              <p>
                ...
                hand-cut velcro. While the design was 3D printable and lightweight, our stakeholders
                said it was extremely uncomfortable due to the thin headband and velcro straps.
                Also, FDM 3D prints are rough and anisotropic, making the bands hard to sanitize and
                easily breakable. Lastly, the shield material was too rigid and obstructed the user
                from moving their head around.
              </p>
            </div>
            <StyledPic>
            ...
            <div>
              <p>
                ...
                bottleneck. Instead of using velcro, the headband had multiple hooks on either side
                that a flexible rubber strap could fasten onto. After I manually adjusted the laser
                cutter for the thickness of the rubber, we could cut 80 straps from one rubber sheet
                in under 30 minutes. Instead of using 2 mm acrylic sheets, we used cheaper 1 mm
                sheets for increased flexibility. I modified the shield to have 45-degree cuts on
                either side, so users could move their heads side-to-side.
              </p>
            </div>
            <div>
              <StyledPic>
